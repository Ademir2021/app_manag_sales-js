    ...
    return (
        <nav className="navbar navbar-expand-lg navbar-dark bg-dark" aria-label="Offcanvas navbar large">
            <div className="container-fluid">
                <a className="navbar-brand" href="/dashboard">Menu Principal</a>
                        ...
                        <ul className="navbar-nav justify-content-end flex-grow-1 pe-3">
                            ...
                            <li className="nav-item dropdown">
                                ...
                                <ul className="dropdown-menu">
                                    <li><a className="dropdown-item" href="/form_person">Cadastro de Clientes</a></li>
                                    <li><a className="dropdown-item" href="/form_product">Cadastro de Produtos</a></li>
                                    <li>
                            ...
                            <li className="nav-item dropdown">
                                ...
                                <ul className="dropdown-menu">
                                    <li><a className="dropdown-item" href="/list_person">Lista de Clientes</a></li>
                                    <li><a className="dropdown-item" href="/list_product">Lista de Produtos</a></li>
                                    <li><a className="dropdown-item" href="/list_users">Lista de Usuários</a></li>
                                    <li>
                                        <hr className="dropdown-divider" />
                                    </li>
                                    <li><a className="dropdown-item" href="#">Vazio</a></li>
